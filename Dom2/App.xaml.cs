...
namespace Dom
{
    ...
    sealed partial class App : Application
    {
        ...
        private void OnLaunchedOrActivated(IActivatedEventArgs e)
        {
            ...
            else if (e is LaunchActivatedEventArgs)
            {
                ...
                // If launched with arguments (not a normal primary tile/applist launch)                // Otherwise if launched normally
        ...
        void WorkwithShell(IActivatedEventArgs e)
        {
    ...
    Window.Current.Content = shell;
            ...
            //    shell.AppFrame.Navigate(typeof(Views.Brama), e.Arguments, new Windows.UI.Xaml.Media.Animation.SuppressNavigationTransitionInfo());
            //}
