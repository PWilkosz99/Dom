...
namespace Dom
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        private List<NavMenuItem> NavFull = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    DestinationPage = typeof(Views.Brama)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Edit,
                    Label = "Biurko LED",
                    DestinationPage = typeof(Views.Biurko)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Favorite,
                    Label = "Page3",
                    DestinationPage = typeof(Views.Bramaold)
                },

            });

        private List<NavMenuItem> NavMedium = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
        ...
        private List<NavMenuItem> NavLow = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
        ...
        public async Task GetuserAsync()
        {
            ...
            if (data == "Szymon")
            {
                NavMenuList.ItemsSource = NavFull;
            }

            else if (data == "Windows 10")
            {
                NavMenuList.ItemsSource = NavMedium;
            }
        }
    }
}
