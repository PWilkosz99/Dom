...
namespace Dom.Views
{
    ...
    public sealed partial class Brama : Page
    {
        ...
        /// <summary>
        /// Zmienna blokująca wysyłanie komunikatu przy uruchomieniu aplikacji
        /// </summary>
        private bool first;
        ...
        {
            Client.BramaSend(Commands.BramaEnum.Otwórz);
        }

        private void Zamknij_Click(object sender, RoutedEventArgs e)
        {
            Client.BramaSend(Commands.BramaEnum.Zamknij);
        }

        private void Stop_Click(object sender, RoutedEventArgs e)
        {
            Client.BramaSend(Commands.BramaEnum.Stop);        
        }
