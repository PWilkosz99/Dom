...
namespace Dom.Views
{
    ...
    public sealed partial class Biurko : Page
    {
        ...
        //-------------------------------------------------------
          ...
          Part Klawiatura = new Part(Commands.BiurkoEnum.Klawiatura);
          Part GornaPolka = new Part(Commands.BiurkoEnum.GornaPolka);
          Part DolnaPolka = new Part(Commands.BiurkoEnum.DolnaPolka);
          Part GornaSzafka = new Part(Commands.BiurkoEnum.GornaSzafka);
          Part DolnaSzafka = new Part(Commands.BiurkoEnum.DolnaSzafka);
          Part Tyl = new Part(Commands.BiurkoEnum.Tyl);
          Part Dodatkowy = new Part(Commands.BiurkoEnum.Dodatkowy);
